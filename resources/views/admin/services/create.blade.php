    ...
    <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1 space-y-4">
            ...
            <div class="bg-white border border-gray-100 shadow-md rounded-xl p-6">
                ...
                <textarea name="description" rows="4" class="w-full border-gray-300 rounded-lg text-sm px-3 py-2 focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-colors"></textarea>
            </div>
        </div>
