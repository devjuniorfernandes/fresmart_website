<x-admin-layout>
    ...
    <div class="flex border border-gray-200 mb-6 bg-white p-2 gap-2 max-w-4xl">
    ...
    @if (session('success'))
        <div
            class="mb-6 max-w-4xl p-4 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-r-xl shadow-sm text-sm">
    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data"
        ...
        <div id="tab-brand" class="tab-content space-y-6">
            <div class="bg-white border border-gray-100 shadow-sm rounded-2xl overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <p class="text-xs text-gray-500 pb-2">Gerencie o logótipo oficial, descrição institucional exibida
                        no rodapé e informações de contacto direto exibidas ao público.</p>

                    <!-- Logo Upload -->
                    <div>
                        <label class="block text-xs font-bold text-slate-600 uppercase mb-1.5 flex items-center gap-2">
                            <i class="fas fa-image text-slate-600 text-sm w-4"></i> Logótipo Oficial
                            (Branco/Transparente preferido)
                        </label>
                        @if ($setting->logo)
                            <div class="mb-3 p-3 bg-[#45B500] rounded-xl inline-block shadow-sm">
                                <img src="{{ asset($setting->logo) }}" class="h-10 w-auto object-contain"
                                    alt="Logo atual">
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            placeholder="Servindo Angola com coração. Qualidade, frescura e os melhores preços perto de si."
                    ...
                    <div class="space-y-4">
                        <h3 class="font-bold text-slate-800 text-xs uppercase tracking-wide">Informações de Contacto
                            Públicas</h3>
        ...
        <div id="tab-social" class="tab-content space-y-6 hidden">
            <div class="bg-white border border-gray-100 shadow-sm rounded-2xl overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <p class="text-xs text-gray-500 pb-2">Preencha as URLs oficiais das contas sociais da marca e os
                        links de download das aplicações móveis nas respetivas lojas.</p>
                    ...
                    <div>
                        ...
                        <input type="url" name="google_play"
                            value="{{ old('google_play', $setting->google_play) }}"
