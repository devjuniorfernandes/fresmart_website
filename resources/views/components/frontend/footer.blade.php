<footer id="#footer" class="bg-[#45B500] pt-7 text-white">
    ...
    <div
        ...
        <div class="col-span-2 lg:col-span-1 space-y-5">
            <img src="{{ $settings->logo ? asset($settings->logo) : asset('assets/img/logo-white.png') }}" alt="FRESMART"
                class="h-20 w-auto">
            <p class="text-sm text-white/80 leading-relaxed">
                {{ $settings->description ?: 'Servindo Angola com coração. Qualidade, frescura e os melhores preços perto de si.' }}
            </p>
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm text-white/90">
                <li><a href="{{ url('/ofertas') }}" class="hover:text-white hover:underline transition">Ofertas</a>
                </li>
                ...
                <li><a href="{{ url('/servicos') }}" class="hover:text-white hover:underline transition">Nossos
                        Serviços</a></li>
                <li><a href="{{ url('/produtos') }}" class="hover:text-white hover:underline transition">Nossos
                        Produtos</a></li>
            </ul>
        </div>
