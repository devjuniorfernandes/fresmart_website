                ...
                <div class="lg:col-span-8 bg-white border border-gray-100 shadow-md p-8 md:p-12 space-y-12">
                    ...
                    <div id="tab-content-empresa" class="tab-pane space-y-8">
                        ...
                        <div class="pt-8 border-t border-gray-100 space-y-6">
                            <div class="border-b border-gray-50 pb-4 mb-2">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Os pilares estratégicos que orientam a nossa
                                    jornada em Angola.</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-2">
                                    ...
                                    <p class="text-sm text-gray-600 leading-relaxed">
                                        A nossa missão é proporcionar uma experiência de compra que inspire confiança em
                                        cada visita, reforçando o compromisso de colocar sempre os nossos clientes em
                                        primeiro lugar e de contribuir para uma alimentação mais prática, equilibrada e
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-sm text-gray-600 leading-relaxed">
                                        Ser reconhecida como a rede de supermercados líder em frescura, proximidade e
                                        inovação no retalho alimentar em Angola, impulsionando a produção nacional e o
                                        bem-estar social.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="pt-8 border-t border-gray-100">
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                                <div class="p-4 space-y-1">
                                    ...
                                    <div class="font-bold uppercase tracking-wider text-gray-700">Lojas em
                                        Angola</div>
                                </div>

                                <div class="p-4 space-y-1">
                                    <div class="text-3xl md:text-4xl font-black text-[#45B500] tracking-tight">+650
                                    </div>
                                    <div class="font-bold uppercase tracking-wider text-gray-700">Colaboradores
                                    </div>
                                </div>

                                <div class="p-4 space-y-1">
                                    <div class="text-3xl md:text-4xl font-black text-[#45B500] tracking-tight">+8.500
                                    </div>
                                    <div class="font-bold uppercase tracking-wider text-gray-700">Produtos no
                                        Sortido</div>
                                </div>

                                <div class="p-4 space-y-1">
                                    <div class="text-3xl md:text-4xl font-black text-[#45B500] tracking-tight">+150
                                    </div>
                                    <div class="font-bold uppercase tracking-wider text-gray-700">Fornecedores
                                        Nacionais</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="tab-content-historia" class="tab-pane space-y-6 hidden">
                        <div class="border-b border-gray-50 pb-4 mb-6">
                            ...
                            <p class="text-sm text-gray-500 mt-1">O caminho percorrido ao serviço das famílias
                                angolanas.</p>
                        </div>
                        ...
                        <!-- Timeline -->
                        <div
                            class="space-y-6 relative before:absolute before:inset-0 before:left-6 before:w-0.5 before:bg-green-200 pt-4">
                            <!-- Step 2014 -->
                            <div class="relative flex items-start gap-6 pl-12">
                                <div class="space-y-1 w-full">
                                    <span class="font-black text-[#45B500] uppercase tracking-wider">2014</span>
                                    <h4 class="text-base font-bold text-gray-900">Início da Operação</h4>
                                    <p class="text-sm text-gray-600 leading-relaxed">
                                        Abertura das primeiras lojas em Luanda, com o firme compromisso de trazer
                                        produtos alimentares frescos e acessíveis para as famílias angolanas.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="relative flex items-start gap-6 pl-12">
                                <div class="space-y-1 w-full">
                                    <span class="font-black text-[#45B500] uppercase tracking-wider">2018</span>
                                    <h4 class="text-base font-bold text-gray-900">Expansão de Lojas e Lançamento do
                                        Cartão Poupança</h4>
                                    <p class="text-sm text-gray-600 leading-relaxed">
                                        Alcançamos a marca de 10 lojas ativas e apresentamos o Cartão Poupança Fresmart,
                                        permitindo poupança real a milhares de agregados familiares.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="relative flex items-start gap-6 pl-12">
                                <div class="space-y-1 w-full">
                                    <span class="font-black text-[#45B500] uppercase tracking-wider">2022</span>
                                    <h4 class="text-base font-bold text-gray-900">Fortalecimento com Produtores
                                        Nacionais</h4>
                                    <p class="text-sm text-gray-600 leading-relaxed">
                                        Estreitamento de acordos diretos com parceiros agrícolas e produtores locais
                                        angolanos para fornecimento diário garantido, melhorando a qualidade dos frescos
                                        nas lojas.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="relative flex items-start gap-6 pl-12">
                                <div class="space-y-1 w-full">
                                    <span class="font-black text-[#45B500] uppercase tracking-wider">Presente</span>
                                    <h4 class="text-base font-bold text-gray-900">+18 Lojas e +650 Colaboradores</h4>
                                    <p class="text-sm text-gray-600 leading-relaxed">
                                        Hoje somos uma rede sólida em crescimento permanente, operando sob elevados
                                        padrões de serviço e focada em ser o parceiro mais fiável no dia a dia angolano.
                                    </p>
                                </div>
                            </div>
                        </div>
