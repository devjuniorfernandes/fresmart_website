<x-frontend.layout>
    <div class="bg-white border-b border-gray-100 py-6">
        <div class="max-w-[1528px] mx-auto px-6 lg:px-10">
            ...
            <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 uppercase mt-1">Notícias & Eventos</h1>
            <p class="text-sm text-gray-500 mt-1">Fique por dentro das novidades, eventos e dicas da Fresmart</p>
        </div>
    </div>
        ...
        <div class="max-w-[1528px] mx-auto px-6 lg:px-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($posts as $post)
                    <article class="bg-white border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between group">
                        <div>
                            <!-- Post Thumbnail -->
